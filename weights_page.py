...
def get_posting(driver, bridge_dict, i):
    ...
    time.sleep(2)
    for i in range (8):
        posting_driver = driver.find_element(By.XPATH, "/html/body/form/div[3]/table/tbody/tr/td/table/tbody/tr/td[2]/table/tbody/tr/td/div[1]/div[1]/div/div[1]/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[1]/td[2]/div/fieldset/table/tbody/tr[2]/td[2]/div/fieldset/table/tbody/tr[" + str(i + 2) + "]/td/table/tbody/tr/td[2]/input")
